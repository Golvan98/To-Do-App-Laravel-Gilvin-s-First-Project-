...
<div class="flex items-center justify-center text-white col-span-8 bg-no-repeat bg-fixed bg-cover row-span-6 ml-1 "
                ...
                <form method="POST" action="/projects/store/{{$projects->id}}" class=" p-6 rounded-xl text-black">
                            @csrf

                            <header class ="flex items-center justify-center">
                                <h5 class="my-1 text-white"> Create Task </h5>
                            </header>
                        ...
                        <button type="submit" class="text-center bg-white rounded-full text-xs font-semibold text-black uppercase py-3 px-4"> Create Task </button>
